...
public class CommodityApplication {
	public static void main(String[] args) {
		...
		goods.add(new Commodity("÷егла", 25, 12, 3));
		goods.add(new Commodity("Ѕлок", 55, 20, 23));
		goods.add(new Commodity("Ѕалка", 225, 22, 33));
		goods.add(new Commodity(" оробка", 45, 42, 4));
		goods.add(new Commodity("¬≥кно", 225, 112, 45));
		goods.add(new Commodity("ƒвер≥", 225, 90, 31));
