...
public class Deputy_13 extends Human_13 {
	...
	public Deputy_13(int weight, int heigth, String firstName, String lastName, int age, boolean bribe, String fraction, int quantityOfBribe) {
		super(weight, heigth);
